...
<div align="center">
   <h1>Exploratory Search (ExSearch) with LLMs</h1>
</div>
...
The warmup learning dataset is released in [Huggingface dataset](https://huggingface.co/datasets/mangopy/Agentic-Search-Warmup-dataset).
